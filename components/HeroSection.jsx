...
export default function HeroSection() {
  ...
  return (
    <section className="relative bg-gradient-to-r from-[var(--hero-gradient-from)] to-[var(--hero-gradient-to)] text-[var(--hero-text)] py-16 md:py-24">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Search Box */}
          <motion.div
            className="bg-[var(--hero-input-bg)] rounded-lg shadow-lg mb-8"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="relative group">
                <button
                  className="flex items-center justify-center px-6 py-3 bg-[var(--hero-button-bg)] text-[var(--hero-text)] font-semibold hover:bg-[var(--hero-button-hover)] shadow-md w-full"
